...
<main>
    <section class="bloque">
        ...
        <h2>Finalidad</h2>
        <p>Los datos personales recogidos a través de este sitio web se utilizan exclusivamente para:</p>
        <ul>
            <li>Gestionar las solicitudes de prematrícula.</li>
            <li>Gestionar el acceso al área privada de alumnos y profesores.</li>
            <li>Comunicaciones relacionadas con la actividad de la escuela de música.</li>
        </ul>
